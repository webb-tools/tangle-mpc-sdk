...
declare module '@polkadot/api-base/types/submittable' {
    interface AugmentedSubmittables<ApiType extends ApiTypes> {
        ...
        jobs: {
            ...
            } | string | Uint8Array, jobId: u64 | AnyNumber | Uint8Array, extendBy: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
            ...
            setPermittedCaller: AugmentedSubmittable<(roleType: TanglePrimitivesRolesRoleType | {
                ...
                LightClientRelaying: any;
            } | string | Uint8Array, jobId: u64 | AnyNumber | Uint8Array, newPermittedCaller: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                TanglePrimitivesRolesRoleType,
                u64,
                AccountId32
            ]>;
             ...
             **/
            setTimeFee: AugmentedSubmittable<(newFee: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u128
            ]>;
            /**
        ...
        roles: {
            ...
            createProfile: AugmentedSubmittable<(profile: PalletRolesProfile | {
                ...
                Shared: any;
            } | string | Uint8Array, maxActiveServices: Option<u32> | null | Uint8Array | u32 | AnyNumber) => SubmittableExtrinsic<ApiType>, [
                PalletRolesProfile,
                Option<u32>
            ]>;
            /**
             ...
             **/
            setMinRestakingBond: AugmentedSubmittable<(minRestakingBond: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u128
            ]>;
            /**
             * See [`Pallet::unbond_funds`].
             **/
            unbondFunds: AugmentedSubmittable<(amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                Compact<u128>
            ]>;
            /**
        ...
        transactionPause: {
             ...
             **/
            pauseTransaction: AugmentedSubmittable<(palletName: Bytes | string | Uint8Array, functionName: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                Bytes,
                Bytes
            ]>;
            /**
             ...
             **/
            unpauseTransaction: AugmentedSubmittable<(palletName: Bytes | string | Uint8Array, functionName: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                Bytes,
                Bytes
            ]>;
            /**
