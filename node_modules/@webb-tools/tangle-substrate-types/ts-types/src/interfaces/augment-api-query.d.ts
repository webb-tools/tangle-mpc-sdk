...
declare module '@polkadot/api-base/types/storage' {
    interface AugmentedQueries<ApiType extends ApiTypes> {
        ...
        jobs: {
            ...
            } | string | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<Option<TanglePrimitivesJobsPhaseResult>>, [
            ...
            submittedJobs: AugmentedQuery<ApiType, (arg1: TanglePrimitivesRolesRoleType | {
                ...
                LightClientRelaying: any;
            } | string | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<Option<TanglePrimitivesJobsJobInfo>>, [
                TanglePrimitivesRolesRoleType,
                u64
            ]> & QueryableStorageEntry<ApiType, [TanglePrimitivesRolesRoleType, u64]>;
            submittedJobsRole: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<TanglePrimitivesRolesRoleType>>, [
                u64
            ]> & QueryableStorageEntry<ApiType, [u64]>;
            timeFeePerBlock: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
            validatorJobIdLookup: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<Vec<ITuple<[TanglePrimitivesRolesRoleType, u64]>>>>, [
                AccountId32
            ]> & QueryableStorageEntry<ApiType, [AccountId32]>;
            validatorRewards: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<u128>>, [
                AccountId32
            ]> & QueryableStorageEntry<ApiType, [AccountId32]>;
            /**
             * Generic query
        ...
        roles: {
             ...
             **/
            accountRolesMapping: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Vec<TanglePrimitivesRolesRoleType>>, [
                AccountId32
            ]> & QueryableStorageEntry<ApiType, [AccountId32]>;
            /**
             ...
             **/
            activeRestakerEra: AugmentedQuery<ApiType, () => Observable<Option<PalletStakingActiveEraInfo>>, [
            ]> & QueryableStorageEntry<ApiType, []>;
            /**
             * Rewards for the last `HISTORY_DEPTH` eras.
             * If reward hasn't been set or has been removed then 0 reward is returned.
             **/
            erasRestakeRewardPoints: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<PalletStakingEraRewardPoints>, [
                u32
            ]> & QueryableStorageEntry<ApiType, [u32]>;
            /**
             * Map from all "controller" accounts to the info regarding the staking.
             **/
            ledger: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<PalletRolesRestakingLedger>>, [
                AccountId32
            ]> & QueryableStorageEntry<ApiType, [AccountId32]>;
            /**
             ...
             **/
            validatorJobsInEra: AugmentedQuery<ApiType, () => Observable<BTreeMap<AccountId32, u32>>, [
            ]> & QueryableStorageEntry<ApiType, []>;
            /**
             * Generic query
             **/
        ...
        transactionPause: {
             ...
             **/
            pausedTransactions: AugmentedQuery<ApiType, (arg: ITuple<[Bytes, Bytes]> | [Bytes | string | Uint8Array, Bytes | string | Uint8Array]) => Observable<Option<Null>>, [
                ITuple<[Bytes, Bytes]>
        ...
        zkSaaS: {
            feeInfo: AugmentedQuery<ApiType, () => Observable<PalletZksaasFeeInfo>, [
            ]> & QueryableStorageEntry<ApiType, []>;
            /**
             * Generic query
             **/
