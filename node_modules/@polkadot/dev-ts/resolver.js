 ...
 **/
export function resolveAlias(specifier, _parentUrl, aliases = tsAliases) {
    ...
    if (found) {
        ...
        return resolveNonAlias(`./${found.alias.path.replace('*', path.join(...parts.slice(found.alias.filter.length)))}`, found.alias.url);
    }
}
/**
