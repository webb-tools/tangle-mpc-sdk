...
export const runtime = {
    TransactionPaymentApi: [
        {
            ...
            methods: objectSpread({}, V3_SHARED_PAY_CALL, V2_TO_V4_SHARED_PAY, V1_TO_V4_SHARED_PAY),
            version: 4
        },
        {
            methods: objectSpread({}, V3_SHARED_PAY_CALL, V2_TO_V4_SHARED_PAY, V1_TO_V4_SHARED_PAY),
        ...
        {
            methods: objectSpread({}, V2_TO_V4_SHARED_PAY, V1_TO_V4_SHARED_PAY),
            version: 2
        },
        {
    ...
    TransactionPaymentCallApi: [
        {
            methods: objectSpread({}, V3_SHARED_PAY_CALL, V2_V3_SHARED_CALL, V1_TO_V3_SHARED_CALL),
            version: 3
        },
        {
            methods: objectSpread({}, V2_V3_SHARED_CALL, V1_TO_V3_SHARED_CALL),
            version: 2
        },
        {
            methods: objectSpread({
